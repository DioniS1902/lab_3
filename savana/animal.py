...
class Animal:
    ...
    def __str__(self):
        return f"Тип живлення: {food_used[self.type_of_food_used.value]}, Клас тварини: {animal_type[self.type_of_food_used.value]}, Кілкість порібної їжі: {self.number_of_food},"
